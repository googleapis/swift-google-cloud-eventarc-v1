# Google Cloud Client Libraries for Swift - Eventarc API
...
Add `swift-google-cloud-eventarc-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-eventarc-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudEventarcV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudEventarcV1 <target-name> --package swift-google-cloud-eventarc-v1
```
